...
import springboot.util.FileUtil;
...
public class FileController {
	...
	@PostMapping("/import")
	public void importKline(@RequestPart(value = "file") final MultipartFile file) throws IOException {
		storageService.bulkImport(file, FileUtil.getCount(file));
	}
