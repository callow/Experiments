...
public interface GnomeKeyringLibrary extends Library {
  ...
  int GNOME_KEYRING_ATTRIBUTE_SIZE = Native.POINTER_SIZE * 3;
   ...
   *      return code
   */
  int gnome_keyring_store_password_sync(GnomeKeyringPasswordSchema schema, String keyring,
      String display_name, String password, Object... args);
   ...
   *      return code
   */
  int gnome_keyring_find_password_sync(GnomeKeyringPasswordSchema schema, PointerToPointer password,
      Object... args);
   ...
   *      return code
   */
  int gnome_keyring_delete_password_sync(GnomeKeyringPasswordSchema schema, Object... args);
   ...
   *    return code
   */
  int gnome_keyring_get_info_sync(String keyring, PointerToPointer keyring_info);
   ...
   */
  void gnome_keyring_info_free(Pointer keyring_info);
   ...
   */
  boolean gnome_keyring_info_get_is_locked(Pointer keyring_info);
  ...
  void gnome_keyring_attribute_list_append_string(Pointer attributes, String name, String value);

  void gnome_keyring_attribute_list_free(Pointer attributes);

  int gnome_keyring_find_items_sync(int type, Pointer attributes, Pointer[] found);

  void gnome_keyring_found_list_free(Pointer found_list);

  int g_list_length(Pointer list);

  GnomeKeyringFound g_list_nth_data(Pointer list, int n);
}
