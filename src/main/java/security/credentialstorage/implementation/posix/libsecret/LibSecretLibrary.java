...
public interface LibSecretLibrary extends Library {
   ...
   *      return code
   */
  boolean secret_password_store_sync(SecretSchema schema, String collection, String label,
      String password, Pointer cancellable, PointerByReference error, Object... args);
   ...
   *      return code
   */
  Pointer secret_password_lookup_sync(SecretSchema schema, Pointer cancellable,
      PointerByReference error, Object... args);
   ...
   *      return code
   */
  boolean secret_password_clear_sync(SecretSchema schema, Pointer cancellable,
      PointerByReference error, Object... args);
   ...
   */
  Pointer secret_service_search_sync(Pointer secret_service, SecretSchema schema,
      Pointer attributes, int flags, Pointer cancellable, PointerByReference error);

  Pointer secret_service_get_sync(int flags, Pointer cancellable, PointerByReference error);

  Pointer secret_collection_for_alias_sync(Pointer secret_service, String alias, int flags,
   ...
   */
  int secret_service_unlock_sync(Pointer secret_service, Pointer objects, Pointer cancellable,
      PointerByReference unlocked, PointerByReference error);
